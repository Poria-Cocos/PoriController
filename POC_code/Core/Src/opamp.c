...
void HAL_OPAMP_MspInit(OPAMP_HandleTypeDef* opampHandle)
{
  ...
  /* USER CODE END OPAMP1_MspInit 0 */
    ...
    PA3     ------> OPAMP1_VINP
    */
    GPIO_InitStruct.Pin = RockerLY_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(RockerLY_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END OPAMP2_MspInit 0 */
    ...
    PA7     ------> OPAMP2_VINP
    */
    GPIO_InitStruct.Pin = RockerLX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(RockerLX_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END OPAMP3_MspInit 0 */
    ...
    PB13     ------> OPAMP3_VINP
    */
    GPIO_InitStruct.Pin = RockerRY_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(RockerRY_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END OPAMP4_MspInit 0 */
    ...
    PB11     ------> OPAMP4_VINP
    */
    GPIO_InitStruct.Pin = RockerRX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(RockerRX_GPIO_Port, &GPIO_InitStruct);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* opampHandle)
{
  ...
  /* USER CODE END OPAMP1_MspDeInit 0 */
    ...
    PA3     ------> OPAMP1_VINP
    */
    HAL_GPIO_DeInit(RockerLY_GPIO_Port, RockerLY_Pin);
  ...
  /* USER CODE END OPAMP2_MspDeInit 0 */
    ...
    PA7     ------> OPAMP2_VINP
    */
    HAL_GPIO_DeInit(RockerLX_GPIO_Port, RockerLX_Pin);
  ...
  /* USER CODE END OPAMP3_MspDeInit 0 */
    ...
    PB13     ------> OPAMP3_VINP
    */
    HAL_GPIO_DeInit(RockerRY_GPIO_Port, RockerRY_Pin);
  ...
  /* USER CODE END OPAMP4_MspDeInit 0 */
    ...
    PB11     ------> OPAMP4_VINP
    */
    HAL_GPIO_DeInit(RockerRX_GPIO_Port, RockerRX_Pin);
